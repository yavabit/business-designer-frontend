...
export const roadmapItems: TimelineItem[] = [
    ...
    { date: '01.07.25', title: 'Feature', description: 'Категория организационной структуры', done: false },
    { date: '01.07.25', title: 'Feature', description: 'Ролевая модель', done: false },
    { date: '01.07.25', title: 'Feature', description: 'Общий рефакторинг', done: false },
